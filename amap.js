...
AMap.prototype.getWxLocation = function(a, b) {
  abridge.getLocation({
    type: 'gcj02',
    success: function(a) {
...
}, AMap.prototype.getRegeo = function(a) {
  function c(c) {
...
}, AMap.prototype.getWeather = function(a) {
  function d(d) {
    var e = 'base';
    a.type && 'forecast' == a.type && (e = 'all'), abridge.httpRequest({
...
}, AMap.prototype.getPoiAround = function(a) {
  function d(d) {
    var e = {
      key: b.key,
      location: d,
    ...
    a.querytypes && (e['types'] = a.querytypes), a.querykeywords && (e['keywords'] = a.querykeywords), abridge.httpRequest({
...
}, AMap.prototype.getStaticmap = function(a) {
  function f(b) {
...
}, AMap.prototype.getInputtips = function(a) {
  var b = this,
    c = b.requestConfig,
    d = {
      key: b.key,
  ...
  a.location && (d['location'] = a.location), a.keywords && (d['keywords'] = a.keywords), a.type && (d['type'] = a.type), a.city && (d['city'] = a.city), a.citylimit && (d['citylimit'] = a.citylimit), abridge.httpRequest({
...
}, AMap.prototype.getDrivingRoute = function(a) {
  var b = this,
    c = b.requestConfig,
    d = {
      key: b.key,
  ...
  a.origin && (d['origin'] = a.origin), a.destination && (d['destination'] = a.destination), a.strategy && (d['strategy'] = a.strategy), a.waypoints && (d['waypoints'] = a.waypoints), a.avoidpolygons && (d['avoidpolygons'] = a.avoidpolygons), a.avoidroad && (d['avoidroad'] = a.avoidroad), abridge.httpRequest({
...
}, AMap.prototype.getWalkingRoute = function(a) {
  var b = this,
    c = b.requestConfig,
    d = {
      key: b.key,
  ...
  a.origin && (d['origin'] = a.origin), a.destination && (d['destination'] = a.destination), abridge.httpRequest({
...
}, AMap.prototype.getTransitRoute = function(a) {
  var b = this,
    c = b.requestConfig,
    d = {
      key: b.key,
  ...
  a.origin && (d['origin'] = a.origin), a.destination && (d['destination'] = a.destination), a.strategy && (d['strategy'] = a.strategy), a.city && (d['city'] = a.city), a.cityd && (d['cityd'] = a.cityd), abridge.httpRequest({
...
}, AMap.prototype.getRidingRoute = function(a) {
  var b = this,
    c = b.requestConfig,
    d = {
      key: b.key,
